...
with lib.hm.gvariant;
{
  dconf.settings = {
    ...
    "org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom0" = {
      ...
      command = lib.hm.gvariant.mkString "/home/fraisa/dev/ripxospeech/ripxospeech.py -a start_dictation -e win11_swe";
      name = lib.hm.gvariant.mkString "Ripxospeech Stop";
    };

    "org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom1" = {
      binding = lib.hm.gvariant.mkString "F10";
      command = lib.hm.gvariant.mkString "/home/fraisa/dev/ripxospeech/ripxospeech.py -a start_dictation -e talon_dictation";
      name = lib.hm.gvariant.mkString "Ripxospeech Stop";
    };

    "org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom2" = {
      binding = lib.hm.gvariant.mkString "F11";
      command = lib.hm.gvariant.mkString "/home/fraisa/dev/ripxospeech/ripxospeech.py -a start_dictation -e talon_command";
      name = lib.hm.gvariant.mkString "Ripxospeech Stop";
    };

    "org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom3" = {
      binding = lib.hm.gvariant.mkString "F12";
      command = lib.hm.gvariant.mkString "/home/fraisa/dev/ripxospeech/ripxospeech.py -a stop_dictation";
      name = lib.hm.gvariant.mkString "Ripxospeech Start";
    };

    "org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom4" = {
      binding = lib.hm.gvariant.mkString "F8";
      command = lib.hm.gvariant.mkString "/home/fraisa/dev/ripxospeech/ripxospeech.py -a start_dictation -e gdocs";
      name = lib.hm.gvariant.mkString "Ripxospeech Start";
    };
  };
